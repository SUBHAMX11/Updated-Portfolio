      ...
      <Box>
        ...
        <Main>
          ...
          <Description>
            ...
            <p>HTML, CSS, JS, ReactJs, NextJs, Saas, etc</p>
          </Description>
          <Description>
            <strong>Tools</strong>
            <p>VScode, Github, Sanity, Atom, Figma, etc.</p>
          </Description>
        </Main>
        <Main>
          <Title>
          ...
          <Description>
            <strong>Skills</strong>
            <p>NodeJs, ExpressJs, MongoDB, REST API, etc</p>
          </Description>
          <Description>
            <strong>Tools</strong>
            <p>VScode, MongoDB, Stripe, Postman, etc</p>
          </Description>
        </Main>
